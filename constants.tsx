...
export const INSURANCES: Insurance[] = [
  ...
  { name: 'Assefaz', slug: 'assefaz', domain: 'assefaz.org.br' },
  { name: 'Asteba', slug: 'asteba' },
  { name: 'Atitude Saúde', slug: 'atitude-saude', domain: 'atitudesaude.com.br' },
  { name: 'BC Saúde', slug: 'bc-saude', domain: 'bcb.gov.br' },
  { name: 'Camed Saúde', slug: 'camed-saude', domain: 'camed.com.br' },
  { name: 'CapSaúde', slug: 'cap-saude', domain: 'capsaude.org.br' },
  { name: 'Casembrapa', slug: 'casembrapa', domain: 'casembrapa.org.br' },
  { name: 'Casseb', slug: 'casseb', domain: 'casseb.com.br' },
  { name: 'Cassi', slug: 'cassi', domain: 'cassi.com.br' },
  { name: 'Codevasf', slug: 'codevasf', domain: 'codevasf.gov.br' },
  { name: 'Conab', slug: 'conab', domain: 'conab.gov.br' },
  { name: 'Fachesf', slug: 'fachesf', domain: 'fachesf.com.br' },
  { name: 'Fusex', slug: 'fusex', domain: 'eb.mil.br' },
  { name: 'Gama', slug: 'gama', domain: 'gamaesaude.com.br' },
  { name: 'Geap Saúde', slug: 'geap-saude', domain: 'geap.org.br' },
  { name: 'Hapvida', slug: 'hapvida', domain: 'hapvida.com.br' },
  { name: 'Hospital Naval', slug: 'hospital-naval', domain: 'marinha.mil.br' },
  { name: 'Life', slug: 'life', domain: 'lifesaude.com.br' },
  { name: 'Nordeste Saúde', slug: 'nordeste-saude' },
  { name: 'NotreDame', slug: 'notredame', domain: 'gndi.com.br' },
  { name: 'Pasa', slug: 'pasa', domain: 'saudepasa.com.br' },
  { name: 'Saúde Petrobrás', slug: 'petrobras', domain: 'saudepetrobras.com.br' },
  { name: 'Plan-Assiste', slug: 'plan-assiste', domain: 'mpu.mp.br' },
  { name: 'Planserv', slug: 'planserv', domain: 'planserv.ba.gov.br' },
  { name: 'Porto Saúde', slug: 'porto-saude', domain: 'portoseguro.com.br' },
  { name: 'Postal Saúde', slug: 'postal-saude', domain: 'postalsaude.com.br' },
  { name: 'Pro-Social', slug: 'pro-social', domain: 'trf1.jus.br' },
  { name: 'Saúde Caixa', slug: 'saude-caixa', domain: 'caixa.gov.br' },
  { name: 'Select', slug: 'select' },
  { name: 'Sepaco', slug: 'sepaco', domain: 'sepaco.org.br' },
  { name: 'Telos', slug: 'telos', domain: 'telos.org.br' },
  { name: 'Trt5', slug: 'trt5', domain: 'trt5.jus.br' },
  { name: 'Unafisco Saúde', slug: 'unafisco-saude', domain: 'unafiscosaude.org.br' },
  { name: 'Vale', slug: 'vale', domain: 'vale.com' }
];
